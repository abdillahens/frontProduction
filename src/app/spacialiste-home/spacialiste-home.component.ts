...
//image ||^^
  ...
  public registreSubmit(){
    ...
    const {nom,prenom,sexe,date_naissance,tele,specialite,adresse} = this.registerForm.value;
    if (this.registerForm.invalid) {
        return;
    }


    this._gestionSpecialiste.updateSpecialiste2(this.user.id,nom,prenom,sexe,date_naissance,this.user.email,tele,specialite,adresse).subscribe(
      res =>{
